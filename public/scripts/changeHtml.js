function changeHtml(data){
    ...
    document.getElementById('weather-icon').setAttribute('src', `https://www.weatherbit.io/static/img/icons/${data[0].icon}.png`);
    ...
    document.getElementById('sunrise').innerHTML = `${transfer(data[0].sunrise)}`;
    document.getElementById('sunset').innerHTML = `${transfer(data[0].sunset)}`;
